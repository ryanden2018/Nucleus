...
pst1 = Post.create(title:"Trees",content:lorem_ipsum,user_id:usr1.id,edited:false,private:false)
Post.create(title:"Boats",content:lorem_ipsum,user_id:usr1.id,edited:false,private:false)
Post.create(title:"Kayaks",content:lorem_ipsum,user_id:usr3.id,edited:false,private:true)
...
Comment.create(post_id:pst1.id,user_id:usr3.id,content:lorem_ipsum_short,edited:false)
